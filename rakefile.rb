...
zip :package => [:publish] do |zip|
    ...
    zip.output_file = "Belz-Latest.zip"
...
task :nuget_package => [:publish] do
    ...
    nuspecs.each do |nuspec|
        update_xml nuspec do |xml|
            ...
            xml.root.elements["metadata/licenseUrl"].text = "https://github.com/acropolium/Belz/blob/master/license.txt"
            xml.root.elements["metadata/projectUrl"].text = "https://github.com/acropolium/Belz"
        end
    end
